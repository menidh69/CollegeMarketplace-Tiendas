...
const Mitiendascreen = () => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.titulo}>Mi tienda info</Text>
      <Image style={styles.logo}
        source={{ uri: tienda.url_imagen }}
      />
      <Text style={styles.titulo}>{tienda.nombre}</Text>
      <TouchableOpacity style={styles.editinfo} onPress={() => navigation.navigate('Editarinfo', {tienda: tienda})} >
